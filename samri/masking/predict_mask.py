def predict_mask(in_file):
    ...
    #                 i = 0
    #                 while os.path.isfile(path.abspath(path.expanduser('classifier/{a}_slice{b}.pdf'.format(a = i, b =slice)))):
    #                     i += 1
    #                 print('\n\n\n\nsaving fig: ', path.abspath(path.expanduser('classifier/{a}_slice{b}.pdf \n\n\n\n'.format(a = i, b =slice))))
    #                 plt.savefig(path.abspath(path.expanduser('classifier/{a}_slice{b}.pdf'.format(a = i, b =slice))), format = 'pdf')
    #                 plt.close()
    ...
    # return nii_path_masked, [resampled_mask_path]
    print('\n\n\n\n\n\n\n\n' + in_file + '\n\n\n\n\n\n\n\n')
    return in_file
